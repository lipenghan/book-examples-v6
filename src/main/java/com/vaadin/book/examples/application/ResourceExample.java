...
public class ResourceExample extends CustomComponent implements BookExampleBundle {
    ...
    @Override
    public void attach() {
        if ("class-basic".equals(context))
            classresource(layout);
        else if ("class-ref".equals(context))
            classref(layout);
        else if ("themeresource".equals(context))
            themeresource(layout);
        else if ("fileresource".equals(context))
            fileresource(layout);
    ...
    void classresource(VerticalLayout layout) {
        // BEGIN-EXAMPLE: application.resources.classresource.class-basic
        ...
        // END-EXAMPLE: application.resources.classresource.class-basic
    ...
    void classref(VerticalLayout layout) {
        ...
        Label label = new Label("Here the image is in the <img src='" +
                "" +
                "'/> of this text", Label.CONTENT_XHTML);
    ...
    void fileresource(VerticalLayout layout) {
        ...
        FileResource resource =
            new FileResource(new File(basepath+"/images/image.png"),
                    getApplication());
    ...
    void local(VerticalLayout layout) {
        ...
        ExternalResource resource =
            new ExternalResource("/book-examples/images/image.png");
