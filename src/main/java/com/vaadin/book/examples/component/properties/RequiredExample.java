...
public class RequiredExample extends CustomComponent implements BookExampleBundle {
    ...
    void basic() {
        ...
        lastName.addValidator(new StringLengthValidator("Must not be empty", 1, 100, false));

        // Commit the buffered form data to the data source
        form.getFooter().addComponent(new Button("OK",
    ...
    void caption(VerticalLayout root) {
        ...
        grid.addComponent(new Label("\u00a0 <b>Layout</b>", Label.CONTENT_XHTML));
        grid.addComponent(new Label("\u00a0 <b>Example</b>", Label.CONTENT_XHTML));
