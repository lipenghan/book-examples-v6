...
public class TreeTableExample extends CustomComponent implements BookExampleBundle {
    ...
    public void init(String context) {
        ...
        if ("basic".equals(context))
            ...
            components(layout);
        else if ("additemafter".equals(context))
            additemafter(layout);
        else if ("draganddrop".equals(context))
            draganddrop(layout);
    ...
    void components(VerticalLayout layout) {
    ...
    void draganddrop (VerticalLayout layout) {
