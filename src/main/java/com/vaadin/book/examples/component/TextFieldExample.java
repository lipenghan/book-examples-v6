...
public class TextFieldExample extends CustomComponent implements BookExampleBundle {
    ...
    public void init (String context) {
        ...
        if ("basic".equals(context))
            basic(layout);
        else if ("inputhandling".equals(context))
            inputhandling(layout);
        else if ("valuetype".equals(context))
            valuetype(layout);
        else if ("databinding".equals(context))
            databinding(layout);
        else if ("beanbinding".equals(context))
            beanbinding(layout);
        else if ("nullvaluerepresentation".equals(context))
            nullvaluerepresentation(layout);
        else if ("widthfitting".equals(context))
            widthfitting(layout);
        else if ("selectall".equals(context))
            selectall(layout);
    ...
    void inputhandling(VerticalLayout layout) {
        // Create a text field
    ...
    void valuetype(VerticalLayout root) {
    ...
    void databinding(final VerticalLayout layout) {
    ...
    public class LenientDoubleValidator extends DoubleValidator {
        ...
        protected boolean isValidString(String value) {
            if ("".equals(value))
                ...
                return super.isValidString(value);
        }
    }
    ...
    void nullvaluerepresentation(VerticalLayout layout) {
    ...
    void maxlength(VerticalLayout layout) {
    ...
    void widthfitting(VerticalLayout layout) {
    ...
    void selectall(VerticalLayout layout) {
        ...
        reselect.addListener(new Button.ClickListener() {
            private static final long serialVersionUID = -3834280813248740190L;
