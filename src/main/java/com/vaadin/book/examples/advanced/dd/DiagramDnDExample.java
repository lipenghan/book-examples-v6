...
public class DiagramDnDExample extends CustomComponent implements BookExampleBundle {
    ...
    void diagram() {
        ...
        connectorResource = new StreamResource(connectors, makeImageFilename(), getApplication());
        ...
        class MoveHandler implements DropHandler {
            ...
            public void drop(DragAndDropEvent event) {
                ...
                Connectable c = (Connectable) ((DragAndDropWrapper)t.getSourceComponent()).getComponentIterator().next();
